...
inline bool AhoCorasick::match_any (const String& text, bool keep) {
    return match_any(text.c_str(), text.length(), keep);
}

inline bool AhoCorasick::match_any(const Packet* p, bool keep) {
...
inline bool AhoCorasick::match_any(const char* text_to_match, int length, bool keep) {
...
inline bool AhoCorasick::is_open() {
